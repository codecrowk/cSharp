...
//       // Firts lets make an insertion sort
//       for (int i = 0; i < numeros.Length; i++)
//       {
//         int smallestNumber = numeros[i];
//         for (int x = 0; x < numeros.Length; x++)
//         {
//           int currentNumber = numeros[x];
//           if (smallestNumber > currentNumber) {
//             numeros[i] = currentNumber;
//             numeros[x] = smallestNumber;
...
//       OrderMyArray ArrayOder = new OrderMyArray();
//       ArrayOder.init();
//     }
//   }
// }